...
@section('content_rekammedis')
  ...
  <form action="/rekammedis/update/{{$rekammedis->ID_REKAM_MEDIS}}" method="post">
    {{ csrf_field() }}
    ...
    TGL PERIKSA : <input type="date" name="TGL_PERIKSA" value = "{{$rekammedis->TGL_PERIKSA}}" required="required"> <br/>
    DIAGNOSA : <input type="text" name="DIAGNOSA" value = "{{$rekammedis->DIAGNOSA}}" required="required"> <br/>
    KETERANGAN : <input type="text" name="KETERANGAN" value = "{{$rekammedis->KETERANGAN}}" required="required"> <br/>
    BIAYA JASA : <input type="text" name="BIAYA_JASA" value = "{{$rekammedis->BIAYA_JASA}}" required="required"> <br/>
